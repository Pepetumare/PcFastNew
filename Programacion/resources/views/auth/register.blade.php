    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="w-full max-w-md px-8 py-10 mx-4 bg-white rounded-lg shadow-xl">
            ...
            <div class="flex flex-col items-center mb-6">
                ...
                <p class="text-sm text-gray-500">Regístrate para comenzar a monitorear tus equipos.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Tu nombre y apellido" />
